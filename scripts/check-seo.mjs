...
const requiredFiles = ["index.html", "checklist.html", "budget.html", "recommend.html", "robots.txt", "sitemap.xml", "vercel.json"];
const pages = ["index.html", "checklist.html", "budget.html", "recommend.html"];
let failed = false;
